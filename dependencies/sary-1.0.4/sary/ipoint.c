 ...
 *
 * $Id: ipoint.c,v 1.5 2000/12/14 08:55:00 rug Exp $
 *
...
/**
 * sary_ipoint_char_ascii:
 * @text: a #SaryText.
 *
 * Assign index points character by character in ASCII encoding (1 octet).
 *
 * Returns: the pointer of the assigned index point; NULL if the
 * end of file reached.
 *
 **/
gchar *
...
/**
 * sary_ipoint_char_iso8859:
 * @text: a #SaryText.
 *
 * Assign index points character by character in ISO-8859-* encoding.
 *
 * Returns: the pointer of the assigned index point; NULL if the
 * end of file reached.
 *
...
/**
 * sary_ipoint_char_eucjp:
 * @text: a #SaryText.
 *
 * Assign index points character by character in EUC-JP encoding.
 *
 * Returns: the pointer of the assigned index point; NULL if the
 * end of file reached.
 *
 ...
 * @text: a #SaryText.
 *
 * Assign index points character by character in Shift_JIS encoding.
 *
 * Returns: the pointer of the assigned index point; NULL if the
 * end of file reached.
 *
...
/**
 * sary_ipoint_char_utf8:
 * @text: a #SaryText.
 *
 * Assign index points character by character in UTF-8 encoding.
 *
 * Returns: the pointer of the assigned index point; NULL if the
 * end of file reached.
 *
 ...
 * @text: a #SaryText.
 *
 * Assign index points line by line.
 *
 * Returns: the pointer of the assigned index point; NULL if the
 * end of file reached.
 *
 ...
 * @text: a #SaryText.
 *
 * Assign index points word by word. The word is a string delimited
 * by whitespaces.
 *
 * Returns: the pointer of the assigned index point; NULL if the
 * end of file reached.
